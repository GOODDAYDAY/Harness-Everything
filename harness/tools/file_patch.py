            ...
            "properties": {
                ...
                "fuzz": {
                    ...
                    "description": (
                        ...
                        "Use 0 for exact matches only. Use 5-10 when the file "
                        "has been edited recently and line numbers may have shifted. "
                        "Increase to 15-20 only for large autogenerated files."
                    ),
                    "default": 3,
                },
                "dry_run": {
